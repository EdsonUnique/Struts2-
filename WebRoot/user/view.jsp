	...
	<HEAD>
		...
		<script type="text/javascript">
			function downloadFile(userID){
				window.location.href="${pageContext.request.contextPath}/user/user_downloadFile?userID="+userID;
		...
		<form id="userAction_save_do" name="Form1" action="${pageContext.request.contextPath}/user/userAction_save.do" method="post" enctype="multipart/form-data">
			...
			<table cellSpacing="1" cellPadding="5" width="100%" align="center" bgColor="#eeeeee" style="border: 1px solid #8ba7e3" border="0">
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff" colSpan="3">
						<a href="javascript:void(0)" onclick="javascript:downloadFile('<s:property value="%{model.userID}"/>')" class="cl_01">

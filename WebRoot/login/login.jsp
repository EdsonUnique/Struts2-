								...
								<table width="452" height="290" border="0" cellpadding="0" cellspacing="0">
									...
									<tr>
										<td align="center" valign="bottom" background="${pageContext.request.contextPath}/images/loginbg.gif">
											<form id="loginAction_home" name="form1" action="${pageContext.request.contextPath}/user/user_login" target="_parent" method="post">
												<table border="0" align="center" cellpadding="2" cellspacing="0">
													...
													<tr>
														...
														<td>
															<s:fielderror fieldName="logonName" theme="simple"/>
														</td>
													...
													<tr>
														...
														<td>
															<s:fielderror fieldName="logonPwd" theme="simple"/>
														</td>
